...
INSERT INTO sensor (deviceId, sensorAddress, sensorName, sensorType, sensorUnit) VALUES (1, '28 39 E8 6D 6 0 0 5D', 'Temp1', 'DS18B20', 'Celsius'); #1
INSERT INTO sensor (deviceId, sensorAddress, sensorName, sensorType, sensorUnit) VALUES (1, '28 35 2 70 6 0 0 E2',  'Temp2', 'DS18B20', 'Celsius'); #2
INSERT INTO sensor (deviceId, sensorAddress, sensorName, sensorType, sensorUnit) VALUES (1, '28 AD E7 6E 6 0 0 D7', 'Temp3', 'DS18B20', 'Celsius'); #3
INSERT INTO sensor (deviceId, sensorAddress, sensorName, sensorType, sensorUnit) VALUES (1, '28 83 99 6F 6 0 0 32', 'Temp4', 'DS18B20', 'Celsius'); #4
INSERT INTO sensor (deviceId, sensorAddress, sensorName, sensorType, sensorUnit) VALUES (1, '28 A7 6A 6F 6 0 0 B0', 'Temp5', 'DS18B20', 'Celsius'); #5

INSERT INTO sensor (deviceId, sensorAddress, sensorName, sensorType, sensorUnit) VALUES (1, 'Digital10', 'Temp', 'DHT', 'Celsius');      #6
INSERT INTO sensor (deviceId, sensorAddress, sensorName, sensorType, sensorUnit) VALUES (1, 'Digital10', 'Humidity', 'DHT', '%');               #7
INSERT INTO sensor (deviceId, sensorAddress, sensorName, sensorType, sensorUnit) VALUES (1, 'Digital10', 'Heat Index', 'DHT', 'Celsius');       #8 

INSERT INTO sensor (deviceId, sensorAddress, sensorName, sensorType, sensorUnit) VALUES (1, 'Analog0', 'Light', 'photocell', 'Luminas'); #9
